...
TAU = 8e-2                     # Soft Update Parameter next 1e-3
...
class DDPG_Agent():
    ...
    def __init__(self,state_size,action_size,num_agents,index):
        ...
        self.critic_local = Critic(state_size,action_size,num_agents).to(device)
        self.critic_target = Critic(state_size,action_size,num_agents).to(device)
